...
@section('title', $SettingsData['site_title'] ? __('Home') . ' - ' . $SettingsData['site_title'] : __('Home') . ' -
        ...
        <div class="row h-100 align-items-center justify-content-center">
            <div class="col-12 col-lg-12 text-center">
                <div class="home-content">
                    <div class="avatar">
                        <img src="{{ $your_photo ? asset('media/' . $your_photo) : asset('frontend/images/avatar.jpg') }}"
                            alt="image" />
                    </div>
                    <h1>{{ $name }}</h1>
                    <h3>{{ $subtitle }}</h3>
                ...
                <div class="row">
                    <div class="col-12 col-md-5 col-lg-5">
                        <div class="info-image">
                            <img src="{{ $aboutdata->your_photo ? asset('media/' . $aboutdata->your_photo) : asset('frontend/images/about-me.jpg') }}"
                                alt="image" />
                        </div>
                    </div>
                    <div class="col-12 col-md-7 col-lg-7">
                        ...
                        <div class="row single-info">
                            ...
                            @if ($aboutdata->email != '')
                                <div class="col-12 col-md-12 col-lg-6">
                                    <p><span>{{ __('Email') }}:</span><a
                                            href="mailto:{{ $aboutdata->email }}">{{ $aboutdata->email }}</a></p>
                                </div>
                            @endif
                            @if ($aboutdata->skype != '')
                                <div class="col-12 col-md-12 col-lg-6">
                        ...
                        <div class="row single-info-btn">
                            <div class="col-12 col-md-12">
                                @if ($aboutdata->download_cv != '')
                                    <a href="{{ asset('media/' . $aboutdata->download_cv) }}"
                                        class="btn black-btn margin-rb">{{ __('Download CV') }}</a>
                                @endif
                                @if ($aboutdata->hire_me != '')
                                    <a href="{{ $aboutdata->hire_me }}"
                                        class="btn black-btn margin-rb">{{ __('Hire Me') }}</a>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    @foreach ($portfolio as $row)
                        <div class="col-12 col-sm-6 col-md-6 col-lg-4 grid-item">
                            <div class="item-box">
                                ...
                                @if ($row->url == '')
                                    <div class="item-info">
                                        <a href="{{ asset('media/' . $row->image) }}" data-lity><span
                        ...
                        <div class="col-12 col-sm-6 col-md-6 col-lg-4 grid-blog">
                            <div class="blog-post blog-overlay">
                                ...
                                <div class="blog-content">
                                    <h2 class="blog-title">
                                        <a
                                            href="{{ route('frontend.article', [$row->id, str_slug($row->title)]) }}">{{ $row->title }}</a>
                                    </h2>
                                    <div class="blog-meta">
                                        <span><i
                                                class="fa fa-clock-o"></i>{{ date('d M , yy', strtotime($row->created_at)) }}
                                        </span>
                            ...
                            <form id="contact-form" novalidate="" data-validate="parsley">
                                ...
                                @if ($SettingsData['recaptcha'] == 1)
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <div class="g-recaptcha" data-sitekey="{{ $SettingsData['sitekey'] }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <input type="text" name="isreCaptcha" id="isreCaptcha" class="display-none"
                                    value="{{ $SettingsData['recaptcha'] }}">
                                <!--route-->
                                <input id="sentContactFormMessageId" type="text" class="display-none"
                                    value="{{ route('frontend.sentContactFormMessage') }}" />
                                <a href="javascript:void(0);"
                                    class="btn black-btn submit-form-class">{{ __('Send Message') }}</a>
                            </form>
                        </div>
                    </div><!--/Contact Form/-->
                    <!--Contact Info-->
