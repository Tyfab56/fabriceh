...
"BWR" stands for "Black, White and Red," which are the primary tones in Fabrice H's compositions in the "Another World" series. The artist's intention is to capture attention by reducing the color palette and concentrating it in shades of red-orange, thereby enhancing the strong lines of the image and playing with the contrast generated by desaturating certain areas. This approach redirects the natural attention the viewer would have given to the original image.
...
The BWR Series benefits from a distinctive delivery method for 1/1 prints; they are personally handed over by the author, regardless of the destination. The artist values meeting collectors and observing the environment in which the artwork will reside.
